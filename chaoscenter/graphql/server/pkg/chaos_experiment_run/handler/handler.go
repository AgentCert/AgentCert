...
func applyUninstallAllPatchToWorkflowSpec(spec *v1alpha1.WorkflowSpec) {
	...
	// See applyUninstallAllPatch in chaos_experiment/ops/service.go for the
	// rationale.  When AGENT_INSTALL_NAMESPACE is set, the agent helm release
	// lives in that system ns; we uninstall there first and fall back to the
	// app ns for legacy releases.
